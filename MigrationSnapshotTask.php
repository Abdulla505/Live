...
class MigrationSnapshotTask extends SimpleMigrationTask
{
    ...
    {
        $namespace = Configure::read('file.php');
        $pluginPath = 'file.php';
        if ($this->plugin) {
            $namespace = $this->_pluginNamespace($this->plugin);
            $pluginPath = $this->plugin . 'file.php';
        }

        $collection = $this->getCollection($this->connection);
        $options = [
            'file.php' => $this->params['file.php'],
            'file.php' => $this->plugin,
        ];
        ...
        $autoId = true;
        if (isset($this->params['file.php'])) {
            $autoId = !$this->params['file.php'];
        }
        ...
        return [
            ...
            'file.php' => $tables,
            'file.php' => 'file.php',
            'file.php' => $this->BakeTemplate->viewVars['file.php'],
            'file.php' => $autoId,
        ];
    }
