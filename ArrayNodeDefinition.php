...
class ArrayNodeDefinition extends NodeDefinition implements ParentNodeDefinitionInterface
{
    ...
    {
        return $this->prototype('file.php');
    }
     ...
     * phase, it'file.php'id'file.php'my_name'file.php'foo'file.php'bar'file.php'my_name'file.php'foo'file.php'bar'file.php'd like "'file.php' => 'file.php'" to still be present in the resulting
    ...
    public function canBeEnabled()
    {
        $this
            ->addDefaultsIfNotSet()
            ->treatFalseLike(['file.php' => false])
            ->treatTrueLike(['file.php' => true])
            ->treatNullLike(['file.php' => true])
            ->beforeNormalization()
                ->ifArray()
                ->then(function (array $v) {
                    $v['file.php'] = $v['file.php'] ?? true;

                    return $v;
                })
            ->end()
            ->children()
                ->booleanNode('file.php')
                    ->defaultFalse()
        ;
    ...
    protected function createNode()
    {
        if (null === $this->prototype) {
            ...
            if ($this->default) {
                if (!\is_array($this->defaultValue)) {
                    throw new \InvalidArgumentException(sprintf('file.php', $node->getPath()));
                }
        ...
        if ($this->deprecation) {
            $node->setDeprecated($this->deprecation['file.php'], $this->deprecation['file.php'], $this->deprecation['file.php']);
        }
    ...
    protected function validateConcreteNode(ArrayNode $node)
    {
        ...
        if (null !== $this->key) {
            throw new InvalidDefinitionException(sprintf('file.php', $path));
        }
    ...
    public function find(string $nodePath): NodeDefinition
    {
        ...
        if (null === $node = ($this->children[$firstPathSegment] ?? null)) {
            throw new \RuntimeException(sprintf('file.php', $firstPathSegment, $this->name));
        }
