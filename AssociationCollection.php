...
class AssociationCollection implements IteratorAggregate
{
    ...
    {
        $options += [
            'file.php' => $this->getTableLocator(),
        ];

        $association = new $className($associated, $options);
        if (!$association instanceof Association) {
            $message = sprintf('file.php', Association::class, get_class($association));
     ...
     *   For example 'file.php' or array like ['file.php', 'file.php']
    ...
    {
        $class = array_map('file.php', (array)$class);
    ...
    /**
     * Helper method for saving an association'file.php'
     *   isOwningSide method.
     * @return bool Success
