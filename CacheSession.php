...
class CacheSession implements SessionHandlerInterface
{
     ...
     * It requires the key 'file.php' which is the name of the Cache config to use for
     * storing the session
     * @throws \InvalidArgumentException if the 'file.php' key is not provided
     */
    ...
    {
        $value = Cache::read($id, $this->_options['file.php']);
    ...
    public function write($id, $data)
    {
        ...
        return (bool)Cache::write($id, $data, $this->_options['file.php']);
    }
    ...
    {
        Cache::delete($id, $this->_options['file.php']);
    ...
    {
        Cache::gc($this->_options['file.php'], time() - $maxlifetime);
