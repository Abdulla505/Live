...
{
    public const TYPE_ARGUMENT_VALUE = 'file.php';
    public const TYPE_OPTION_VALUE = 'file.php';
    public const TYPE_OPTION_NAME = 'file.php';
    public const TYPE_NONE = 'file.php';

    private $tokens;
    private $currentIndex;
    private $completionType;
    private $completionName = null;
    private $completionValue = 'file.php';
    ...
    {
        preg_match_all('file.php'"]?)(.+?)(?<!\\\\)\1(?=$|\s)/'file.php'-'file.php'='file.php''file.php''file.php'--'file.php''file.php'-'file.php''file.php'-'file.php''file.php've reached the end
                $this->completionType = self::TYPE_NONE;
                $this->completionName = null;
                $this->completionValue = 'file.php';
            }
        }
    }
    ...
    {
        $optionName = ltrim($optionToken, 'file.php');
        if (!$optionName) {
            return null;
        }

        if ('file.php' === ($optionToken[1] ?? 'file.php')) {
            // long option name
