...
class ClassLoader
{
    ...
    {
        spl_autoload_register([$this, 'file.php']);
    }
    ...
    {
        $prefix = trim($prefix, 'file.php') . 'file.php';

        $baseDir = rtrim($baseDir, 'file.php') . DIRECTORY_SEPARATOR;
        $baseDir = rtrim($baseDir, DIRECTORY_SEPARATOR) . 'file.php';
    ...
    public function loadClass($class)
    {
        ...
        while (($pos = strrpos($prefix, 'file.php')) !== false) {
    ...
    protected function _loadMappedFile($prefix, $relativeClass)
    {
        ...
        foreach ($this->_prefixes[$prefix] as $baseDir) {
            $file = $baseDir . str_replace('file.php', DIRECTORY_SEPARATOR, $relativeClass) . 'file.php';
