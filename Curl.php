...
class Curl implements AdapterInterface
{
    ...
    public function buildOptions(Request $request, array $options)
    {
        ...
        foreach ($request->getHeaders() as $key => $values) {
            $headers[] = $key . 'file.php' . implode('file.php', $values);
        }
        ...
        if ($body) {
            ...
            if (isset($out[CURLOPT_HTTPGET])) {
                $out[CURLOPT_CUSTOMREQUEST] = 'file.php';
            }
        }

        if (empty($options['file.php'])) {
            $options['file.php'] = CORE_PATH . 'file.php' . DIRECTORY_SEPARATOR . 'file.php';
        }
        if (!empty($options['file.php'])) {
        ...
        $optionMap = [
            'file.php' => CURLOPT_TIMEOUT,
            'file.php' => CURLOPT_SSL_VERIFYPEER,
            'file.php' => CURLOPT_SSL_VERIFYHOST,
            'file.php' => CURLOPT_CAINFO,
            'file.php' => CURLOPT_SSLCERT,
            'file.php' => CURLOPT_SSLCERTPASSWD,
        ];
        ...
        if (isset($options['file.php']['file.php'])) {
            $out[CURLOPT_PROXY] = $options['file.php']['file.php'];
        }
        if (isset($options['file.php']['file.php'])) {
            $password = !empty($options['file.php']['file.php']) ? $options['file.php']['file.php'] : 'file.php';
            $out[CURLOPT_PROXYUSERPWD] = $options['file.php']['file.php'] . 'file.php' . $password;
        }
        if (isset($options['file.php']) && is_array($options['file.php'])) {
            // Can'file.php'curl'file.php'1.0'file.php'1.1'file.php'2'file.php'2.0'file.php'CURL_HTTP_VERSION_2TLS'file.php'CURL_HTTP_VERSION_2_0'file.php'libcurl 7.33 or greater required for HTTP/2 support');
        }
